            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        ...
                        <form action="{{ route('update-meta-tags') }}" enctype="multipart/form-data" method="post" id="meta-tags-form" class="smart-form row" autocomplete="off" data-parsley-validate>
                            @csrf
                            @method('PUT')
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    <label class="form-label" for="page_title">{{ __('Page Title') }}<span class="text-danger">*</span></label>
                                    <input type="text" id="page_title" name="page_title" class="form-control" value="{{ $meta_tags->page_title }}" data-parsley-required="true" required>
                                </div>
                            </div>
                            <div class="mb-3 col-12">
                                <div class="form-group">
                                    <label class="form-label" for="description">{{ __('Description') }} <span class="text-danger">*</span></label>
                                    <textarea id="description" name="description" rows="2" class="form-control" data-parsley-required="true" required>{{ $meta_tags->description }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 col-12">
                                <div class="form-group">
                                    <label class="form-label" for="keywords">{{ __('Keywords') }} <span class="text-danger">*</span></label>
                                    <textarea id="keywords" name="keywords" rows="2" class="form-control" data-parsley-required="true" required>{{ $meta_tags->keywords }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    <label class="form-label" for="og_title">{{ __('OG Title') }}<span class="text-danger">*</span></label>
                                    <input type="text" id="og_title" name="og_title" class="form-control" value="{{ $meta_tags->og_title }}" data-parsley-required="true" required>
                                </div>
                            </div>
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    <label class="form-label" for="og_type">{{ __('OG Type') }}<span class="text-danger">*</span></label>
                                    <input type="text" id="og_type" name="og_type" class="form-control" value="{{ $meta_tags->og_type }}" data-parsley-required="true" required>
                                </div>
                            </div>
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    <label class="form-label" for="og_url">{{ __('OG Url') }}<span class="text-danger">*</span></label>
                                    <input type="text" id="og_url" name="og_url" class="form-control" value="{{ $meta_tags->og_url }}" data-parsley-required="true" required>
                                </div>
                            </div>
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    <label class="form-label" for="og_sitename">{{ __('OG Sitename') }}<span class="text-danger">*</span></label>
                                    <input type="text" id="og_sitename" name="og_sitename" class="form-control" value="{{ $meta_tags->og_sitename }}" data-parsley-required="true" required>
                                </div>
                            </div>
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    <label class="form-label" for="og_email">{{ __('OG Email') }}<span class="text-danger">*</span></label>
                                    <input type="text" id="og_email" name="og_email" class="form-control" value="{{ $meta_tags->og_email }}" data-parsley-required="true" required>
                                </div>
                            </div>
                            <div class="mb-3 col-12">
                                <div class="form-group">
                                    <label class="form-label" for="og_description">{{ __('OG Description') }} <span class="text-danger">*</span></label>
                                    <textarea id="og_description" name="og_description" rows="2" class="form-control" data-parsley-required="true" required>{{ $meta_tags->og_description }}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    <label class="form-label" for="og_image">{{ __('OG Image') }}<span class="text-danger">*</span></label>
                                    <input type="file" id="og_image" name="og_image" class="form-control" value="{{ $meta_tags->og_image }}">
                                </div>
                            </div>
                            <div class="mb-3 col-6">
                                <div class="form-group">
                                    @if(Storage::exists('public/meta_tags/' . $meta_tags->og_image))
                                        <img id="preview-image-before-upload"
                                            src="{{ asset(env('ASSETS_PATH').'storage/app/private/public/meta_tags/' . $meta_tags->og_image) }}"
                                            alt="preview image"
                            ...
                            <input type="hidden" class="form-control" name="id" value="{{ $meta_tags->id }}">
