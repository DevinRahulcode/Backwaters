<link id="vendorsbundle" rel="stylesheet" media="screen, print" href="{{ url('back/css/vendors.bundle.css')}}">
<link id="appbundle" rel="stylesheet" media="screen, print" href="{{ url('back/css/app.bundle.css')}}">
<link id="myskin" rel="stylesheet" media="screen, print" href="{{ url('back/css/skins/skin-master.css')}}">
...
<!-- sweet alert -->
<link href="{{ url('back/libs/sweetalert2/sweetalert2.min.css') }}" type="text/css" rel="stylesheet">
...
<link rel="stylesheet" media="screen, print" href="{{ url('back/css/formplugins/select2/select2.bundle.css') }}">

<!-- page ssummer note CSS below -->
<link href="https://cdn.jsdelivr.net/npm/summernote@0.9.0/dist/summernote-bs4.min.css" rel="stylesheet">

<link rel="stylesheet" media="screen,print" href="{{url('back/css/themes/table.css')}}" rel="stylesheet">
<style>
    #preloader {
        position: fixed;
        width: 100%;
