...
<aside class="page-sidebar">
    <div class="page-logo">
        <a class="page-logo-link press-scale-down d-flex align-items-center position-relative" >
            <img src="{{ url('/back/img/logo.png') }}" alt="SmartAdmin Laravel" aria-roledescription="logo">
            <span class="mr-1 page-logo-text">Black Water</span>
        </a>
    </div>
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <div class="info-card">
            @if(isset(Auth::user()->profile_image))
                <a  data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="ml-2 header-icon d-flex align-items-center justify-content-center">
            ...
            @else
                <a  data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="ml-2 header-icon d-flex align-items-center justify-content-center">
                    <img src="{{ url('back/img/profileicon.jpg') }}" class="profile-image rounded-circle" alt="Dr. Codex Lantern" style="width: 40px; height: 40px; object-fit: cover; border-radius: 50%;">
                </a>
            @endif
